        ...
        <div class="product">
          ...
          <div class="productInfo">
            ...
            <div class="productMeta">
              ...
              <div class="productMetaSize"><span><b>Mărime:</b> ${escapeHtml(size)}</span></div>
            </div>
          </div>
        </div>
      </td>
      <td class="code codeEmphasis">${escapeHtml(line.product_code || "-")}</td>
      <td class="code codeEmphasis">${escapeHtml(line.barcode || "-")}</td>
...
<style>
  ...
  * { box-sizing:border-box; }
  ...
  table{width:100%;max-width:100%;border-collapse:collapse;table-layout:fixed}thead{display:table-header-group}tr{break-inside:avoid;page-break-inside:avoid}th{background:#26384b;color:#fff;border:1px solid #26384b;padding:2.2mm 1.4mm;font-size:7.7px;line-height:1.2;text-transform:uppercase;text-align:left}td{border:1px solid #d4dcdf;padding:1.7mm 1.4mm;font-size:8.7px;line-height:1.25;vertical-align:middle;overflow-wrap:anywhere}tbody tr:nth-child(even) td{background:#f8fafb}
  th:nth-child(1),td:nth-child(1){width:6mm}th:nth-child(2),td:nth-child(2){width:58mm}th:nth-child(3),td:nth-child(3){width:20mm}th:nth-child(4),td:nth-child(4){width:24mm}th:nth-child(5),td:nth-child(5){width:8mm}th:nth-child(6),td:nth-child(6){width:9mm}th:nth-child(7),td:nth-child(7){width:17mm}th:nth-child(8),td:nth-child(8){width:19mm}th:nth-child(9),td:nth-child(9){width:23mm}
  thead th:nth-child(1),thead th:nth-child(3),thead th:nth-child(4),thead th:nth-child(5),thead th:nth-child(6),thead th:nth-child(7),thead th:nth-child(8),thead th:nth-child(9){text-align:center}
  .codeHeader{font-size:8px;font-weight:700;letter-spacing:.025em}
  .center{text-align:center}.qty{text-align:center;font-size:11px;font-weight:700;color:#255f54}.code{font-family:"Courier New",monospace;font-size:8.15px;line-height:1.25;overflow-wrap:anywhere}.codeEmphasis{text-align:center;font-weight:700;color:#172033;letter-spacing:.01em}.checkCell{text-align:center}.checkBox{display:inline-block;width:6.2mm;height:6.2mm;border:1.4px solid #334155;border-radius:1.2mm;background:#fff;vertical-align:middle}.money{text-align:right;white-space:nowrap;font-variant-numeric:tabular-nums}.value{font-weight:700;color:#183d36}.product{display:flex;align-items:center;gap:2mm;min-width:0}.productInfo{min-width:0;flex:1}.product strong{display:block;font-size:9.3px;line-height:1.22;color:#172033}.productMeta{margin-top:1mm;color:#435164;font-size:7.8px;line-height:1.28}.productMetaRow{display:flex;flex-wrap:wrap;gap:.35mm 1.8mm}.productMetaSize{margin-top:.55mm}.productMeta span{white-space:nowrap}.productMeta b{color:#1f3d37;font-weight:700}.img{width:9mm;height:11mm;flex:0 0 auto;object-fit:contain;border:1px solid #d4dcdf;border-radius:1.5mm;background:#fff}.img.empty{display:flex;align-items:center;justify-content:center;padding:1mm;color:#9aa4ae;font-size:5.5px;text-align:center}

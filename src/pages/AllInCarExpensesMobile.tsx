...
export default function AllInCarExpensesMobile() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: CUPE.bgBlue, ...cssVars }}>
      ...
      <div className="p-3">
        <Card className="rounded-lg border-slate-300 bg-white text-slate-800">
          <button
  type="button"
  onClick={() => setFiltersOpen((s) => !s)}
  aria-expanded={filtersOpen}
  className="w-full flex items-center justify-between px-3 py-2 border-b border-slate-200 text-left hover:bg-slate-50"
>
  ...
  <span className="text-slate-600" aria-hidden="true">
    {filtersOpen ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
      ...
      <div className="p-3 grid grid-cols-3 gap-2">
        <Card className="rounded-md border-slate-300 text-slate-800">

...
export default function AllInVacations() {
  return (
      ...
      <div className="w-full max-w-3xl px-4">
        <div className="rounded-lg border border-white/20 bg-white/5 shadow-sm px-6 py-8">
          <div className="flex items-center justify-between gap-4">
            <h1 className="text-white text-xl font-semibold">SZABADSÁGOK</h1>
            <Button
          ...
          <div className="mt-6 text-white/80 text-sm">
            Ide jön a szabadságok modul (kérelmek, jóváhagyás, naptár).
          </div>
        </div>
      </div>
    </div>

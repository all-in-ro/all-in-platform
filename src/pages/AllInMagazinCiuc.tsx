...
const SHOP_ADMIN_UNLOCK_KEY = "allin:shop-administration-unlock:csikszereda";
...
export default function AllInMagazinCiuc({
  apiBase = "/api",
        ...
        <section className="grid gap-3 md:grid-cols-[1fr_auto]">
          <div className="rounded-2xl border border-[#7bd7d4]/28 bg-[#244750] px-4 py-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-white">Csíkszeredai értékesítési felület</p>
